...
import cards.actions.DistributeShotsAction;
import cards.actions.DistributeSwallowsAction;
...
public class Deck {
    ...
    private void loadAllPossibleCards() {
        // --- COMMON KARTEN (40%) ---
        allCommonCards.add(new PunishCard("Stolperstein", "Du nimmst 2 Schlucke.", Rarity.COMMON, new DistributeSwallowsAction(2)));
        allCommonCards.add(new PunishCard("Kurzer Aussetzer", "Nimm 3 Schlucke.", Rarity.COMMON, new DistributeSwallowsAction(3)));
        ...
        // --- UNCOMMON KARTEN (25%) ---
        allUncommonCards.add(new PunishCard("Falsch abgebogen", "Nimm 5 Schlucke.", Rarity.UNCOMMON, new DistributeSwallowsAction(5)));
        ...
        // --- RARE KARTEN (20%) ---
        allRareCards.add(new PunishCard("Donnerschlag", "Du musst sofort einen Shot nehmen.", Rarity.RARE, new DistributeShotsAction(1)));
